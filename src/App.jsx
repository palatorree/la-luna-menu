...
const MENU_DATA = {
  ...
  // ---  { id: "mcal-11", categoryId: "mariscos-calientes", name: { es: "Camarones Estilo Louisiana (4 personas)", en: "Louisiana Style Shrimp (Serves 4)" }, description: { es: "Estilo Louisiana ideal para compartir.", en: "Louisiana style perfect for sharing." }, price: 120.00, image: "", tags: ["chef"], spicyLevel: 2 },
    ...
    { id: "ost-2", categoryId: "mariscos-frios", name: { es: "Ostiones (6 piezas)", en: "Oysters (6 pieces)" }, description: { es: "Ostiones frescos en su concha.", en: "Fresh oysters in shell." }, price: 20.00, image: "/images/OSTIONESNUEVO.jpeg", tags: [], spicyLevel: 0 },
    ...
    { id: "beb-3", categoryId: "bebidas", subcategoryId: "sin-alcohol", name: { es: "Red Bull", en: "Red Bull" }, description: { es: "Bebida energizante.", en: "Energy drink." }, price: 7.00, image: "", tags: [], spicyLevel: 0 },
    ...
    { id: "beb-21", categoryId: "bebidas", subcategoryId: "cocteles", name: { es: "Margarita de Sabor", en: "Flavored Margarita" }, description: { es: "A elegir: Fresa, Mango, Tamarindo, Maracuyá o Piña.", en: "Choice of: Strawberry, Mango, Tamarind, Passion Fruit or Pineapple." }, price: 14.00, image: "", tags: [], spicyLevel: 0 },
    ...
    { id: "beb-26", categoryId: "bebidas", subcategoryId: "cocteles", name: { es: "Mojito de Sabor", en: "Flavored Mojito" }, description: { es: "A elegir: Fresa, Mango, Maracuyá o Frutos Rojos.", en: "Choice of: Strawberry, Mango, Passion Fruit or Red Berries." }, price: 14.00, image: "/images/margarita.jpeg", tags: [], spicyLevel: 0 },
