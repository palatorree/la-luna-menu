...
const MENU_DATA = {
  ...
  categories: [
    ...
    { id: "postres-extras", label: { es: "Postres & Extras", en: "Desserts & Sides" }, icon: Cake }
  ],
  ...
  items: [
    ...
    { id: "des-20", categoryId: "desayunos", name: { es: "Sandwich Especial de Desayuno", en: "Special Breakfast Sandwich" }, description: { es: "Tocino, huevo, jamón, lechuga, cebolla y tomate.", en: "Bacon, egg, ham, lettuce, onion and tomato." }, price: 18.99, image: "", tags: [], spicyLevel: 0 },
    ...
    { id: "ent-5", categoryId: "entradas", name: { es: "Carne Seca en Botana", en: "Beef Jerky Snack" }, description: { es: "Con pepino, Tostitos y cacahuates.", en: "With cucumber, Tostitos and peanuts." }, price: 15.00, image: "", tags: [], spicyLevel: 0 },
    ...
    { id: "mcal-2", categoryId: "mariscos-calientes", name: { es: "Camarones a la Diabla", en: "Diabla Shrimp" }, description: { es: "Acompañados de arroz y ensalada.", en: "Served with rice and salad." }, price: 29.99, image: "", tags: [], spicyLevel: 3 },
    ...
    { id: "mcal-8", categoryId: "mariscos-calientes", name: { es: "Camarones Empanizados", en: "Breaded Shrimp" }, description: { es: "Acompañados de arroz y ensalada.", en: "Served with rice and salad." }, price: 29.99, image: "", tags: [], spicyLevel: 0 },
    { id: "mcal-9", categoryId: "mariscos-calientes", name: { es: "Caldo de Camarón", en: "Shrimp Soup" }, description: { es: "Caldo tradicional de camarón.", en: "Traditional shrimp soup." }, price: 29.99, image: "", tags: [], spicyLevel: 0 },
    ...
    { id: "agu-2", categoryId: "mariscos-frios", name: { es: "Aguachiles Rojos", en: "Red Aguachiles" }, description: { es: "Curtidos en limón o cocidos.", en: "Lime-cured or cooked." }, price: 29.99, image: "", tags: [], spicyLevel: 2 },
    { id: "agu-3", categoryId: "mariscos-frios", name: { es: "Aguachiles Piquín", en: "Piquin Aguachiles" }, description: { es: "Curtidos en limón o cocidos con chile piquín.", en: "Lime-cured or cooked with piquin pepper." }, price: 29.99, image: "", tags: [], spicyLevel: 3 },
    { id: "agu-4", categoryId: "mariscos-frios", name: { es: "Aguachiles Negros", en: "Black Aguachiles" }, description: { es: "Salsa negra de la casa. Curtidos en limón o cocidos.", en: "House black sauce. Lime-cured or cooked." }, price: 29.99, image: "", tags: ["popular"], spicyLevel: 2 },
    ...
    { id: "cev-4", categoryId: "mariscos-frios", name: { es: "Ceviche de Mango", en: "Mango Ceviche" }, description: { es: "Ceviche preparado con toque de mango fresco.", en: "Ceviche prepared with a touch of fresh mango." }, price: 29.99, image: "", tags: [], spicyLevel: 1 },
    { id: "cev-5", categoryId: "mariscos-frios", name: { es: "Ceviche de Camarón con Pulpo", en: "Shrimp and Octopus Ceviche" }, description: { es: "Mezcla de camarón y pulpo picado.", en: "Mix of diced shrimp and octopus." }, price: 35.00, image: "", tags: ["popular"], spicyLevel: 0 },
    ...
    { id: "ost-2", categoryId: "mariscos-frios", name: { es: "Ostiones (6 piezas)", en: "Oysters (6 pieces)" }, description: { es: "Ostiones frescos en su concha.", en: "Fresh oysters in shell." }, price: 20.00, image: "", tags: [], spicyLevel: 0 },
    ...
    { id: "lun-6", categoryId: "cortes", name: { es: "Carne Asada con Camarón", en: "Carne Asada with Shrimp" }, description: { es: "Carne asada combinada con camarones.", en: "Carne asada combined with shrimp." }, price: 33.00, image: "", tags: [], spicyLevel: 0 },
    ...
    { id: "tac-1", categoryId: "antojitos", name: { es: "Tacos (Asada, Pastor, Pollo o Adobada)", en: "Tacos (Asada, Pastor, Chicken or Adobada)" }, description: { es: "Taco individual a elegir carne.", en: "Single taco with choice of meat." }, price: 5.00, image: "", tags: [], spicyLevel: 0 },
    ...
    // --- POSTRES & EXTRAS ---
    { id: "sid-1", categoryId: "postres-extras", name: { es: "Papas Fritas", en: "French Fries" }, description: { es: "Papas fritas crujientes.", en: "Crispy french fries." }, price: 6.00, image: "", tags: [], spicyLevel: 0 },
    { id: "sid-2", categoryId: "postres-extras", name: { es: "Puré de Papa", en: "Mashed Potatoes" }, description: { es: "Puré de papa casero.", en: "Homemade mashed potatoes." }, price: 4.00, image: "", tags: [], spicyLevel: 0 },
    { id: "sid-3", categoryId: "postres-extras", name: { es: "Espárragos", en: "Asparagus" }, description: { es: "Espárragos a la parrilla.", en: "Grilled asparagus." }, price: 4.00, image: "", tags: [], spicyLevel: 0 },
    { id: "sid-4", categoryId: "postres-extras", name: { es: "Ensalada", en: "Salad" }, description: { es: "Ensalada fresca de la casa.", en: "Fresh house salad." }, price: 4.00, image: "", tags: [], spicyLevel: 0 },
    { id: "sid-5", categoryId: "postres-extras", name: { es: "Beans", en: "Beans" }, description: { es: "Frijoles de la casa.", en: "House beans." }, price: 4.00, image: "", tags: [], spicyLevel: 0 },
    { id: "sid-6", categoryId: "postres-extras", name: { es: "Chips", en: "Chips" }, description: { es: "Totopos crujientes.", en: "Crispy tortilla chips." }, price: 4.00, image: "", tags: [], spicyLevel: 0 },
    { id: "sid-7", categoryId: "postres-extras", name: { es: "Arroz", en: "Rice" }, description: { es: "Arroz de la casa.", en: "House rice." }, price: 4.00, image: "", tags: [], spicyLevel: 0 },
    { id: "sid-8", categoryId: "postres-extras", name: { es: "Salsa", en: "Salsa" }, description: { es: "Salsa extra.", en: "Extra salsa." }, price: 2.00, image: "", tags: [], spicyLevel: 1 },
    { id: "sid-9", categoryId: "postres-extras", name: { es: "Aguacate", en: "Avocado" }, description: { es: "Porción de aguacate.", en: "Side of avocado." }, price: 3.00, image: "", tags: [], spicyLevel: 0 },
    { id: "sid-10", categoryId: "postres-extras", name: { es: "Tortillas", en: "Tortillas" }, description: { es: "Tortillas hechas a mano.", en: "Handmade tortillas." }, price: 4.00, image: "", tags: [], spicyLevel: 0 },
